...
public class AdminControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int countProduct = pdao.NumberOfProducts();
        int countCategory = cadao.NumberOfCategory();
        int countAccount = udao.NumberOfUser();
        int countSupplier = udao.NumberOfSupplier();
