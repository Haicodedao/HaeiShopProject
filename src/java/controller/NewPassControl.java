 ...
 * @author admin
 */
@WebServlet(name="NewPassControl", urlPatterns={"/newpass"})
public class NewPassControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NewPassControl</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewPassControl at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        dao.UpdatePass(user, newpass);
        request.setAttribute("succ", "Mật khẩu đã được đổi thành công");
