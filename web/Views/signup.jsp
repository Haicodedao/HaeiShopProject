                ...
                <div class="grid">
                    ...
                    <div class="header-with-search" style="display: flex; justify-content: space-around">
                        ...
                        <div class="header__title">
                            <a href="signup" class="header__title-login">
                                Đăng Kí
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="auth-form" style="margin: auto;">
                        <div class="auth-form__container">
                            <header class="auth-form__header">
                                ...
                                <span class="auth-form__switch-control" onclick=""><a href="login">Đăng nhập</a></span>
                            </header>
                            <form id="f1" method="post">
                                <c:if test="${requestScope.messignup != null}">
