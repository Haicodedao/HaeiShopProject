    ...
    <body>
                        ...
                        <div class="card">
                            <div class="row" style="">
                                ...
                                <div class="col-lg-6" style="text-align: center; margin-top: 20px; margin-bottom: 20px;padding-top: 20px">
                                    <form action="maccount" method="post" style="display: flex; justify-content: center">
                                    ...
                                    <div style="text-align: center; margin: 40px 0; " class="col-lg-2">
                                        <button onclick="location.href = 'maccount'" style="border: 1px solid #0061f2; border-radius: 4px; color: white; background-color: #0061f2">
                                            Tất cả tài khoản
                                        </button>
                                        <button onclick="location.href = 'adminmanager'" style="border: 1px solid #0061f2; border-radius: 4px; color: white; background-color: #0061f2; margin-top: 20px">
                                            Tất cả Manager
                                        </button>
                                    </div>
                        </div>

                        <c:if test="${requestScope.erroradmin!=null }">
                            <div style="margin-top: 20px" class="alert alert-danger">
                                ${requestScope.erroradmin}
                            </div>
                        </c:if>
                        <c:if test="${requestScope.messadmin!=null }">
                            <div style="margin-top: 20px" class="alert alert-success">
                                ${requestScope.messadmin}
                            </div>
                        </c:if>
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody id="contentt">
                                        <c:forEach items="${requestScope.listAcc}" var="acc">
                                            <tr>
                                                <td class="text_page" style="font-weight: 500">${acc.name}</td>
                                                <td class="text_page"  style="font-weight: 500">
                                                    <img style="width: 70px; height: auto" src="./asset/img/user.jpg">
                                                </td>
                                                <td class="text_page"  style="font-weight: 500">${acc.user}</td>
                                                <td class="text_page"  style="font-weight: 500">${acc.address}</td>
                                                <td class="text_page"  style="font-weight: 500"> ${acc.role.roid == 1 ? "Admin" : (acc.role.roid == 2 ? "Manager" : "Customer")}</td>
                                                <td class="text_page"  style="font-weight: 500">${u.phone}</td>
                                                <td class="text_page"  style="padding: 0 12px 16px">
                                                    <a href="admindeleteacc?accid=${acc.id}" onclick="return confirmDelete();">
        ...
        <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="form" action="adminaddacc">
                        ...
                        <div class="modal-body">	
                            ...
                            <div class="form-group">
                                <input name="roleId" value="1" type="radio" class="form-check-input" id="isAdmin">
                                <label class="form-check-label" for="isAdmin">Admin</label>
                                <input name="roleId" value="2" type="radio" class="form-check-input" id="isManager">
        ...
        <script type="text/javascript">
            function confirmDelete(){
                return confirm("Bạn có chắc chắn muốn xóa người dùng ?");
            }
        </script>
    </body>
</html>